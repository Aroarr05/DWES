...
public class Empresa {
    ...
    public static Empresa cargadorDeContexto(String nombre) {
        ...
        DirectivoNota[] directivosAnotados = claseEmpresa.getAnnotationsByType(DirectivoNota.class);
        TecnicoNota[] tecnicosAnotados = claseEmpresa.getAnnotationsByType(TecnicoNota.class);
        OficialNota[] oficialesAnotados = claseEmpresa.getAnnotationsByType(OficialNota.class);
